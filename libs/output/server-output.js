...
ServerOutput.prototype.sendHTML = function(url,req,res){
...
ServerOutput.prototype.sendCSS = function(url,req,res){
...
ServerOutput.prototype.sendJS = function(url,req,res){
  var jsName = '',urlMap = this.urlMap;
  for(var i = 0,l = urlMap.length;i<l;i++){
...
ServerOutput.prototype.sendError = function(url,req,res){
  res.writeHead(200,{'Content-Type':'application/javascript; charset=utf-8','Server':'Babel-Dev-Server'});
  res.write('请求路径错误');
  res.end();
}
module.exports = ServerOutput;
